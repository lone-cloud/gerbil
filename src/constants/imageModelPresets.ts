...
export const IMAGE_MODEL_PRESETS: readonly ImageModelPreset[] = [
  ...
  },
  {
    name: 'Krea 2 Turbo',
    sdclipg: '',
    sdclipl: `${HUGGINGFACE_BASE_URL}/Qwen/Qwen3-VL-4B-Instruct-GGUF/resolve/main/Qwen3VL-4B-Instruct-Q4_K_M.gguf`,
    sdmodel: `${HUGGINGFACE_BASE_URL}/realrebelai/KREA-2_GGUFs/resolve/main/TURBO/Krea-2-Turbo-Q4_K_M.gguf`,
    sdphotomaker: '',
    sdt5xxl: '',
    sdvae: `${HUGGINGFACE_BASE_URL}/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/vae/wan_2.1_vae.safetensors`,
  },
  {
    name: 'Ideogram 4',
    sdclipg: `${HUGGINGFACE_BASE_URL}/leejet/ideogram-4-GGUF/resolve/main/ideogram4_uncond-Q4_0.gguf`,
    sdclipl: `${HUGGINGFACE_BASE_URL}/Qwen/Qwen3-VL-8B-Instruct-GGUF/resolve/main/Qwen3VL-8B-Instruct-Q4_K_M.gguf`,
    sdmodel: `${HUGGINGFACE_BASE_URL}/leejet/ideogram-4-GGUF/resolve/main/ideogram4-Q4_0.gguf`,
    sdphotomaker: '',
    sdt5xxl: '',
    sdvae: `${HUGGINGFACE_BASE_URL}/koboldcpp/GGUFDumps/resolve/main/flux2vae.safetensors`,
  },
  {
    name: 'Boogu Edit',
    sdclipg: '',
    sdclipl: `${HUGGINGFACE_BASE_URL}/Qwen/Qwen3-VL-8B-Instruct-GGUF/resolve/main/Qwen3VL-8B-Instruct-Q4_K_M.gguf`,
    sdmodel: `${HUGGINGFACE_BASE_URL}/realrebelai/Boogu-Image-Edit_GGUFs/resolve/main/boogu-edit-dit-Q5_1.gguf`,
    sdphotomaker: '',
    sdt5xxl: '',
    sdvae: `${HUGGINGFACE_BASE_URL}/koboldcpp/GGUFDumps/resolve/main/flux1vae.safetensors`,
  },
